...
export default async function NewlyAddedPage() {
  const result = await getDiscoverySection("new", { page: 1, limit: 18 });

  return (
    <div className="min-h-screen bg-background px-4 md:px-8 lg:px-12 py-8">
      <ViewAllHeader title="Newly Added" icon="🆕" total={result.total} />
