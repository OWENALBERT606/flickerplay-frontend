...
export function MoviesSidebar({ genres, vjs, years }: MoviesSidebarProps) {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-56 shrink-0 sticky top-20 self-start h-[calc(100vh-5rem)] overflow-y-auto pr-2 scrollbar-thin">
      <div className="py-4 space-y-6">

        {/* ── Search ── */}
        <div>
          <p className="px-1 text-[11px] font-semibold uppercase tracking-wider text-muted-foreground mb-2">
            Search
          </p>
        ...
        <div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <SideItem
              icon={Star}
              label="Top Rated"
              active={searchParams.get("sort") === "rating"}
        ...
        <div>
          ...
          <div className="flex flex-col gap-1">
            <SideItem
              icon={Languages}
              label="Translated (VJ)"
              active={activeDubbed === "yes"}
              onClick={() => push({ dubbed: activeDubbed === "yes" ? "" : "yes" })}
            />
            <SideItem
              icon={Globe}
              label="Original"
              active={activeDubbed === "no"}
